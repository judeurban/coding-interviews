...
4 is missing from the array, and A appears twice.
...
class Solution:
    ...
    def repeatedNumber(self, A):
        ...
        # subtract one of two occurances of A
        total_sum = total_sum - a

        # b is the difference between these two values
